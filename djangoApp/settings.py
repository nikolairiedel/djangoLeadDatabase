...
Generated by 'django-admin startproject' using Django 2.1.dev20180303195639.
...
# If you want to test the program without debug mode with the django server,
...
INSTALLED_APPS = [
    'leadsDatabase.apps.LeadsdatabaseConfig',
